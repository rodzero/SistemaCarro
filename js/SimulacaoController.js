function SimulacaoController(elem) {
    var controller = {};
    ...
    function getLocalizacao() {
        ...
        var errorCallback = function(error){
            ...
            AppCarro.mostraNotificacao('Localização', errorMessage, 'error');
        };
    ...
    function removeSimulacao(li, simulacao) {
        ...
        if(window.confirm('Confirma a exclusão do registro?')) {
            ...
            AppCarro.persisteSimulacoes();
            AppCarro.mostraNotificacao('Simulações', 'Simulação removida com sucesso', 'success');
        }
    }
